<?php
if ( ! class_exists( 'Newslite_Sidebar_Recent_Post_Widget' ) ) :
     ...
     *
     */
    class Newslite_Sidebar_Recent_Post_Widget extends WP_Widget {

        function __construct() {
            parent::__construct(
                'newslite_sidebar_recent_post_widget', // Base ID
                __('Newslite: Recent Post Widget', 'newslite'), // Name
        ...
        function form( $instance ) {
            ...
            <p>
                <label for="<?php echo absint($this->get_field_id('post_category')); ?>"><?php _e( 'Category:', 'newslite' ); ?></label>
                <?php
                $cat_args = array(
                    'orderby'         => 'name',
                    'hide_empty'      => 0,
                    ...
                    'show_option_all' => __( 'All Categories','newslite' ),
                );
                wp_dropdown_categories( $cat_args );
                ?>
            </p>
            <p>
                <label for="<?php echo absint($this->get_field_id( 'post_number' )); ?>"><?php _e('Number of Posts:', 'newslite' ); ?></label>
        ...
        function dropdown_post_columns( $args ){
            ...
            $choices = array(
                '1' => sprintf( __( '%d Column','newslite' ), 1 ),
                '2' => sprintf( __( '%d Columns','newslite' ), 2 ),
            );
    ...
    add_action( 'widgets_init', 'newslite_recent_post_widget' );

    if ( ! function_exists( 'newslite_recent_post_widget' ) ) :
         ...
         *
         */
        function newslite_recent_post_widget(){
            // Latest News widget
            register_widget( 'Newslite_Sidebar_Recent_Post_Widget' );
        }
